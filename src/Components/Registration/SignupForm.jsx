        ...
        <div className="w-full ">
          ...
          <form action="" className="mt-8" onSubmit={handleSubmit(formSubmit)}>
            <div>
              ...
              <input
                type="text"
                name="recruiter_user_firstname"
                className="w-full rounded-full border border-gray-300 ps-4 p-2 mt-2 focus:outline-none"
                placeholder="enter first name"
                {...register("recruiter_user_firstname", { required: true })}
              />
              {errors.recruiter_user_firstname && (
            ...
            <div className="mt-5">
              ...
              <input
                type="text"
                name="recruiter_user_lastname"
                className="w-full rounded-full border border-gray-300 ps-4 p-2 mt-2 focus:outline-none"
                placeholder="enter last name"
                {...register("recruiter_user_lastname", { required: true })}
              />
              {errors.recruiter_user_lastname && (
            ...
            <div className="mt-5">
              ...
              <input
                type="email"
                name="recruiter_user_email"
                className="w-full rounded-full border border-gray-300 ps-4 p-2 mt-2 focus:outline-none"
                placeholder="enter your email"
                {...register("recruiter_user_email", { required: true })}
              />
              {errors.recruiter_user_email && (
            ...
            <div className="mt-5">
              ...
              <input
                ...
                {...register("recruiter_user_password", {
              ...
              {errors.recruiter_user_password && (
                <p className="text-red-600">
                  {errors.recruiter_user_password.message}
                </p>
              )}
            </div>
            ...
            <div className="mt-5">
              ...
              <input
                ...
                {...register("confirm_password", {
                  ...
                  validate: (value) => {
                    if (watch("recruiter_user_password") != value) {
