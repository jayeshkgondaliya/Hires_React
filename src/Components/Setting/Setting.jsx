...
function Setting() {
  ...
  const newPassword = watch("recruiter_user_new_password");
  ...
  const formSubmit = async (formData) => {
    ...
    try {
      const { data } = await FetchAPI(changePasswordUserAPI(), "PATCH", {
        ...
        recruiter_user_email: userData.recruiter_user_email,
        recruiter_user_password: formData.recruiter_user_password,
        recruiter_user_new_password: formData.recruiter_user_new_password,
      });
      console.log(data);
          ...
          <div className="col-span-12 md:col-span-8 xl:col-span-9 ">
            <div className="relative">
              <input
                ...
                {...register("recruiter_user_password", { required: true })}
              />
              {showCurrentPassword ? (
                <div
          ...
          <div className="col-span-12 md:col-span-8 xl:col-span-9 md:mt-5">
            <div className="relative">
              <input
                ...
                name="recruiter_user_new_password"
                className="w-full p-2 rounded-md border-gray-300 border mt-1 focus:outline-none "
                placeholder="new password"
                {...register("recruiter_user_new_password", {
            ...
            {errors.recruiter_user_new_password && (
            ...
            <div className="relative">
              <input
                ...
                {...register("confirm_password", {
                  ...
                  validate: (value) => {
                    if (watch("recruiter_user_new_password") != value) {
